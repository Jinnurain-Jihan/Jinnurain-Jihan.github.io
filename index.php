...
<head>
  ...
  <!-- Favicons -->
  <link href="assets/img/<?php echo $data["fav_img"]; ?>" rel="icon">
...
<body>
  ...
  <header id="header">
    <div class="container">
      ...
      <h2>I'm a passionate <span style="color: #18d26e;"><?php echo $data["title"]; ?></span> from <?php echo $data["place"]; ?></h2>
      ...
      <div class="social-links">
        ...
        <?php
         if($data["whatsapp"]){
        ?>
         <a href="<?php echo $data["whatsapp"]; ?>" target="_blank" class="facebook"><i class="bi bi-whatsapp"></i></a>
        <?php 
        }
        ?>
      </div>
    ...
    <div class="about-me container">
      ...
      <div class="row">
        <div class="col-lg-4" data-aos="fade-right">
          <img src="assets/img/<?php echo $aboutData['image'] ?>" class="img-fluid" alt="me">
        </div>
          ...
          ?>
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <img src="assets\img\testimonials\<?php echo $testimonialsData['image'] ?>" class="testimonial-img" alt="">
    ...
    <div class="container">
      ...
      <div class="row portfolio-container">
        <?php include "include/config.php";
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-<?= $portfolioData["category"]?>">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/<?= $portfolioData["image"]?>" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4><?= $portfolioData["title"]?></h4>
                <div class="portfolio-links">
                  <a href="assets/img/portfolio/<?= $portfolioData["image"]?>" data-gallery="portfolioGallery" class="portfolio-lightbox" title="<?= $portfolioData["title"]?>"><i class="bx bx-plus"></i></a>
                  <a href="<?= $portfolioData["project_url"]?>" title="Live" target="_blank"><i class="bx bx-link"></i></a>
                </div>
              </div>
            </div>
          </div>
